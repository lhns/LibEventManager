...
public class UnmodifiableTuple extends AbstractUnmodifiableTuple implements Tuple, RandomAccess, Cloneable, Serializable {
    ...
    public UnmodifiableTuple(Object... array) {
        elementData = Arrays.copyOf(array, array.length);
    }

    public UnmodifiableTuple(Collection<?> collection) {
    ...
    public Tuple subList(int paramInt1, int paramInt2) {
        return new UnmodifiableTuple(Arrays.copyOfRange(elementData, paramInt1, paramInt2));
    }
    ...
    @Override
    public UnmodifiableTuple clone() throws CloneNotSupportedException {
        return new UnmodifiableTuple(elementData);
    }
