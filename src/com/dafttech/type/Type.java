...
public abstract class Type<ClassType> {
  public static final TypeInteger INTEGER = new TypeInteger();
  ...
  public static final TypeCharacter CHARACTER = new TypeCharacter();
  public static final TypeByte BYTE = new TypeByte();
  public static final TypeBoolean BOOLEAN = new TypeBoolean();
  public static final TypeObject OBJECT = new TypeObject();
